...
<head>
  ...
  <title>City Council candidate database | Candidate</title>
...
<div class="row hide" id="candFinance">
	...
	<div class="large-7 medium-8 columns">
		<div class="show-for-medium-up">
			...
			<script type="text/javascript" src="http://bridge.caspio.net/scripts/e1.js"></script>
			<script type="text/javascript">try{f_cbload("e76c00009a5a4a5489914e4ba3ea","http:");}catch(v_e){;}</script>
